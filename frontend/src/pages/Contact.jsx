    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-10 justify-center mb-28 text-sm">
        ...
        <div className="flex flex-col justify-center gap-6 items-start">
          ...
          <p className="text-gray-500">Bangalore<br />Karnataka</p>
          <p className="text-gray-500">Email: darshan@gmail.com</p>
          <p className="font-semibold text-lg text-gray-600 uppercase">Careers at MediHub</p>
